...
import { createGameObjectTest, createUnityTypeTest } from "./test-utilities";
...
export function testUnityGameObject(): TestResult {
  ...
  suite.addResult(
    createGameObjectTest("GameObject static methods should be available", gameObjectClass => {
      if (!gameObjectClass) {
      ...
      console.log(
        `    FindGameObjectsWithTag method: ${findGameObjectsWithTagMethod !== null ? "Available" : "Not available"}`,
      );
  ...
  suite.addResult(
    createGameObjectTest("GameObject creation methods should be available", gameObjectClass => {
      if (!gameObjectClass) {
        console.log("    (Skipped: GameObject class not available)");
        return;
      }
  ...
  suite.addResult(
    createGameObjectTest("GameObject instance methods should be available", gameObjectClass => {
      if (!gameObjectClass) {
        console.log("    (Skipped: GameObject class not available)");
        return;
      }
  ...
  suite.addResult(
    createGameObjectTest("GameObject component methods should be available", gameObjectClass => {
      if (!gameObjectClass) {
        console.log("    (Skipped: GameObject class not available)");
        return;
      }
      ...
      console.log(
        `    GetComponentInChildren: ${getComponentInChildrenMethod !== null ? "Available" : "Not available"}`,
      );
  ...
  suite.addResult(
    createGameObjectTest("GameObject transform operations should be available", gameObjectClass => {
      if (!gameObjectClass) {
        console.log("    (Skipped: GameObject class not available)");
        return;
      }
      ...
      if (getTransformMethod) {
        ...
        if (transformClass) {
          ...
          console.log(
            `    Transform position methods: ${getPositionMethod !== null && setPositionMethod !== null ? "Available" : "Not available"}`,
          );
        }
      }
  ...
  suite.addResult(
    createGameObjectTest("GameObject properties should be accessible", gameObjectClass => {
      if (!gameObjectClass) {
        console.log("    (Skipped: GameObject class not available)");
        return;
      }
      ...
      console.log(
        `    activeInHierarchy property: ${activeInHierarchyProperty !== null ? "Available" : "Not available"}`,
      );
