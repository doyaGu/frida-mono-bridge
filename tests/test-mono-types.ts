...
export function testMonoTypes(): TestResult {
  ...
  suite.addResult(
    createDomainTest("Should load core library assembly", domain => {
  ...
  suite.addResult(
    createDomainTest("Should find Unity assemblies", domain => {
  ...
  suite.addResult(
    createDomainTest("Should explore assembly metadata", domain => {
  ...
  suite.addResult(
    createDomainTest("Should validate assembly names and properties", domain => {
      // Use direct assembly lookup to avoid slow getAssemblies() call
      const mscorlib = domain.assembly("mscorlib");
  ...
  suite.addResult(
    createDomainTest("Should handle assembly lookup variations", domain => {
  ...
  suite.addResult(
    createDomainTest("Should test assembly caching and consistency", domain => {
  ...
  suite.addResult(
    createDomainTest("Should work with assembly classes and types", domain => {
  ...
  suite.addResult(
    createDomainTest("Should test Unity-specific assembly operations", domain => {
