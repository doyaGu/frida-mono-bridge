...
export function createMonoObjectTests(): TestResult[] {
  ...
  results.push(createMonoDependentTest(
    "MonoObject should be creatable from class",
    () => {
  ...
  results.push(createMonoDependentTest(
    "MonoObject should have class reference",
    () => {
      const domain = Mono.domain;
      const objectClass = domain.class("System.Object");
      assertNotNull(objectClass, "System.Object should exist");
  ...
  results.push(createMonoDependentTest(
    "MonoObject.clone should create new object",
    () => {
      const domain = Mono.domain;
      const objectClass = domain.class("System.Object");
      assertNotNull(objectClass, "System.Object should exist");
      ...
      // Different pointers
      assert(
        obj.pointer.toString() !== cloned.pointer.toString(),
        "Clone should have different pointer"
      );
    }
  ));

  results.push(createMonoDependentTest(
    "MonoObject.clone should preserve class",
    () => {
      const domain = Mono.domain;
      const objectClass = domain.class("System.Object");
      assertNotNull(objectClass, "System.Object should exist");
      ...
      // Same class
      assert(
        obj.getClass().getFullName() === cloned.getClass().getFullName(),
        "Clone should have same class"
      );
    }
  ));

  results.push(createMonoDependentTest(
    "MonoObject.deepClone should create new object",
    () => {
      const domain = Mono.domain;
      const objectClass = domain.class("System.Object");
      assertNotNull(objectClass, "System.Object should exist");
      ...
      assert(
        obj.pointer.toString() !== cloned.pointer.toString(),
        "Deep clone should have different pointer"
      );
    }
  ));

  results.push(createMonoDependentTest(
    "MonoObject.deepClone should accept maxDepth parameter",
    () => {
      const domain = Mono.domain;
      const objectClass = domain.class("System.Object");
      assertNotNull(objectClass, "System.Object should exist");
  ...
  results.push(createMonoDependentTest(
    "MonoObject.deepClone should preserve class",
    () => {
      const domain = Mono.domain;
      const objectClass = domain.class("System.Object");
      assertNotNull(objectClass, "System.Object should exist");
      ...
      assert(
        obj.getClass().getFullName() === cloned.getClass().getFullName(),
        "Deep clone should have same class"
      );
    }
  ));
  ...
  results.push(createMonoDependentTest(
    "MonoObject should return correct class type",
    () => {
      const domain = Mono.domain;
      const objectClass = domain.class("System.Object");
      assertNotNull(objectClass, "System.Object should exist");
  ...
  results.push(createMonoDependentTest(
    "MonoObject toString should work",
    () => {
      const domain = Mono.domain;
      const objectClass = domain.class("System.Object");
      assertNotNull(objectClass, "System.Object should exist");
  ...
  results.push(createMonoDependentTest(
    "MonoObject equals should work for same object",
    () => {
      const domain = Mono.domain;
      const objectClass = domain.class("System.Object");
      assertNotNull(objectClass, "System.Object should exist");
  ...
  results.push(createMonoDependentTest(
    "MonoObject clone should not be equal by pointer",
    () => {
      const domain = Mono.domain;
      const objectClass = domain.class("System.Object");
      assertNotNull(objectClass, "System.Object should exist");
  ...
  results.push(createErrorHandlingTest(
    "MonoObject operations should handle null gracefully",
    () => {
      const domain = Mono.domain;
      const objectClass = domain.class("System.Object");
      assertNotNull(objectClass, "System.Object should exist");
