...
export function createMonoStringTests(): TestResult[] {
  ...
  results.push(createMonoDependentTest(
    'MonoString - length property (from static field)',
    () => {
  ...
  results.push(createMonoDependentTest(
    'MonoString - length property equals getLength()',
    () => {
      ...
      assert(lengthProp === lengthMethod, 
        `length property (${lengthProp}) should equal getLength() (${lengthMethod})`);
    }
  ));
  ...
  // =====================================================
  results.push(createMonoDependentTest(
    'MonoString.new() - create empty string',
    () => {
  ...
  results.push(createMonoDependentTest(
    'MonoString.new() - create ASCII string',
    () => {
      const testValue = 'Hello, World!';
      const str = MonoString.new(Mono.api, testValue);
      assertNotNull(str, 'Created string should not be null');
      assert(str.length === testValue.length, 
        `String length should be ${testValue.length}, got ${str.length}`);
      assert(str.toString() === testValue, 
        `toString() should return "${testValue}", got "${str.toString()}"`);
    }
  ));

  results.push(createMonoDependentTest(
    'MonoString.new() - create Unicode string (Chinese)',
    () => {
  ...
  results.push(createMonoDependentTest(
    'MonoString.new() - create Unicode string (Japanese)',
    () => {
  ...
  results.push(createMonoDependentTest(
    'MonoString.new() - create Unicode string (Korean)',
    () => {
  ...
  results.push(createMonoDependentTest(
    'MonoString.new() - create Unicode string (emoji)',
    () => {
      const testValue = '😀🎉🔥';
      const str = MonoString.new(Mono.api, testValue);
      assertNotNull(str, 'Created string should not be null');
      ...
      assert(str.length === expectedLength, 
        `Emoji string length should be ${expectedLength} (surrogate pairs), got ${str.length}`);
      assert(str.toString() === testValue, 
        'toString() should return original emoji string');
    }
  ));

  results.push(createMonoDependentTest(
    'MonoString.new() - create mixed content string',
    () => {
  ...
  results.push(createMonoDependentTest(
    'MonoString.new() - create string with special characters',
    () => {
  ...
  results.push(createMonoDependentTest(
    'MonoString.new() - create string with null character',
    () => {
      ...
      assert(result.startsWith('Before'), 
        `String should start with "Before", got "${result}"`);
    }
  ));
  ...
  results.push(createMonoDependentTest(
    ...
    () => {
      ...
      for (let i = 0; i < testValue.length; i++) {
        ...
        assert(char === testValue.charAt(i), 
          `charAt(${i}) should be '${testValue.charAt(i)}', got '${char}'`);
      }
    }
  ));

  results.push(createMonoDependentTest(
    'MonoString - charAt() with Unicode',
    () => {
      const testValue = '你好';
      const str = MonoString.new(Mono.api, testValue);
  ...
  results.push(createMonoDependentTest(
    'MonoString - charAt() first character',
    () => {
  ...
  results.push(createMonoDependentTest(
    'MonoString - charAt() last character',
    () => {
      const testValue = 'Test';
      const str = MonoString.new(Mono.api, testValue);
  ...
  results.push(createMonoDependentTest(
    'MonoString - charAt() middle character',
    () => {
  ...
  // =====================================================
  results.push(createMonoDependentTest(
    'MonoString - substring() with start only',
    () => {
      const testValue = 'Hello World';
      const str = MonoString.new(Mono.api, testValue);
  ...
  results.push(createMonoDependentTest(
    'MonoString - substring() with start and length',
    () => {
      const testValue = 'Hello World';
      const str = MonoString.new(Mono.api, testValue);
  ...
  results.push(createMonoDependentTest(
    'MonoString - substring() from beginning',
    () => {
  ...
  results.push(createMonoDependentTest(
    'MonoString - substring() from middle',
    () => {
      const testValue = 'ABCDEFG';
      const str = MonoString.new(Mono.api, testValue);
  ...
  results.push(createMonoDependentTest(
    'MonoString - substring() with Unicode',
    () => {
      const testValue = '你好世界';
      const str = MonoString.new(Mono.api, testValue);
  ...
  results.push(createMonoDependentTest(
    'MonoString - substring() entire string',
    () => {
      const testValue = 'Hello';
      const str = MonoString.new(Mono.api, testValue);
  ...
  results.push(createMonoDependentTest(
    'MonoString - substring() empty result',
    () => {
      const testValue = 'Hello';
      const str = MonoString.new(Mono.api, testValue);
  ...
  // =====================================================
  results.push(createMonoDependentTest(
    'MonoString - contains() found at start',
    () => {
      const testValue = 'Hello World';
      const str = MonoString.new(Mono.api, testValue);
  ...
  results.push(createMonoDependentTest(
    'MonoString - contains() found at end',
    () => {
      const testValue = 'Hello World';
      const str = MonoString.new(Mono.api, testValue);
  ...
  results.push(createMonoDependentTest(
    'MonoString - contains() found in middle',
    () => {
      const testValue = 'Hello World';
      const str = MonoString.new(Mono.api, testValue);
  ...
  results.push(createMonoDependentTest(
    'MonoString - contains() empty search',
    () => {
      const testValue = 'Hello World';
      const str = MonoString.new(Mono.api, testValue);
  ...
  results.push(createMonoDependentTest(
    'MonoString - contains() case sensitive',
    () => {
      const testValue = 'Hello World';
      const str = MonoString.new(Mono.api, testValue);
  ...
  results.push(createMonoDependentTest(
    'MonoString - contains() with Unicode',
    () => {
      const testValue = '你好世界';
      const str = MonoString.new(Mono.api, testValue);
  ...
  results.push(createMonoDependentTest(
    'MonoString - contains() entire string',
    () => {
      const testValue = 'Hello';
      const str = MonoString.new(Mono.api, testValue);
  ...
  results.push(createMonoDependentTest(
    'MonoString - startsWith() empty prefix',
    () => {
      const testValue = 'Hello World';
      const str = MonoString.new(Mono.api, testValue);
  ...
  results.push(createMonoDependentTest(
    'MonoString - startsWith() entire string',
    () => {
      const testValue = 'Hello';
      const str = MonoString.new(Mono.api, testValue);
  ...
  results.push(createMonoDependentTest(
    'MonoString - startsWith() case sensitive',
    () => {
      const testValue = 'Hello World';
      const str = MonoString.new(Mono.api, testValue);
  ...
  results.push(createMonoDependentTest(
    'MonoString - startsWith() single char',
    () => {
      const testValue = 'Hello';
      const str = MonoString.new(Mono.api, testValue);
  ...
  results.push(createMonoDependentTest(
    'MonoString - startsWith() with Unicode',
    () => {
      const testValue = '你好世界';
      const str = MonoString.new(Mono.api, testValue);
  ...
  results.push(createMonoDependentTest(
    'MonoString - endsWith() empty suffix',
    () => {
      const testValue = 'Hello World';
      const str = MonoString.new(Mono.api, testValue);
  ...
  results.push(createMonoDependentTest(
    'MonoString - endsWith() entire string',
    () => {
      const testValue = 'Hello';
      const str = MonoString.new(Mono.api, testValue);
  ...
  results.push(createMonoDependentTest(
    'MonoString - endsWith() case sensitive',
    () => {
      const testValue = 'Hello World';
      const str = MonoString.new(Mono.api, testValue);
  ...
  results.push(createMonoDependentTest(
    'MonoString - endsWith() single char',
    () => {
      const testValue = 'Hello';
      const str = MonoString.new(Mono.api, testValue);
  ...
  results.push(createMonoDependentTest(
    'MonoString - endsWith() with Unicode',
    () => {
      const testValue = '你好世界';
      const str = MonoString.new(Mono.api, testValue);
  ...
  // =====================================================
  results.push(createMonoDependentTest(
    'MonoString - toString() returns string value',
    () => {
      const testValue = 'Hello World';
      const str = MonoString.new(Mono.api, testValue);
      const result = str.toString();
  ...
  results.push(createMonoDependentTest(
    'MonoString - toString() caching (returns same value)',
    () => {
  ...
  results.push(createMonoDependentTest(
    'MonoString - toString() with long string',
    () => {
  ...
  results.push(createMonoDependentTest(
    'MonoString - toString() from runtime string',
    () => {
  ...
  // =====================================================
  results.push(createMonoDependentTest(
    'MonoString - empty string operations',
    () => {
      const str = MonoString.new(Mono.api, '');
  ...
  results.push(createMonoDependentTest(
    'MonoString - single character string',
    () => {
  ...
  results.push(createMonoDependentTest(
    'MonoString - string with numbers',
    () => {
  ...
  results.push(createMonoDependentTest(
    'MonoString - mixed ASCII and Unicode',
    () => {
  ...
  // =====================================================
  results.push(createMonoDependentTest(
    'MonoString - immutability (create new for modifications)',
    () => {
  ...
  results.push(createMonoDependentTest(
    'MonoString - consistent length across operations',
    () => {
  ...
  results.push(createMonoDependentTest(
    'MonoString - substring does not modify original',
    () => {
      const testValue = 'Hello World';
      const str = MonoString.new(Mono.api, testValue);
  ...
  // =====================================================
  results.push(createMonoDependentTest(
    'MonoString - charAt() boundary test (first index)',
    () => {
      const str = MonoString.new(Mono.api, 'Test');
      const char = str.charAt(0);
  ...
  results.push(createMonoDependentTest(
    'MonoString - charAt() boundary test (last index)',
    () => {
      const str = MonoString.new(Mono.api, 'Test');
  ...
  results.push(createMonoDependentTest(
    'MonoString - contains() longer than string',
    () => {
  ...
  results.push(createMonoDependentTest(
    'MonoString - startsWith() longer prefix',
    () => {
      const str = MonoString.new(Mono.api, 'Hi');
  ...
  results.push(createMonoDependentTest(
    'MonoString - endsWith() longer suffix',
    () => {
      const str = MonoString.new(Mono.api, 'Hi');
  ...
  // =====================================================
  results.push(createMonoDependentTest(
    'MonoString - round trip: create and read back',
    () => {
      const values = [
        'Simple',
        '你好',
      ...
      for (const testValue of values) {
        ...
        assert(result === testValue, 
          `Round trip failed for "${testValue}", got "${result}"`);
      }
    }
  ));

  results.push(createMonoDependentTest(
    'MonoString - chained operations',
    () => {
  ...
  results.push(createMonoDependentTest(
    'MonoString - multiple strings independent',
    () => {
