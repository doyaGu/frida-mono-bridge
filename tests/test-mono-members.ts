...
export function testMonoMembers(): TestResult {
  ...
  suite.addResult(
    createMonoDependentTest("Mono.perform should work for method tests", () => {
      assertPerformWorks("Mono.perform() should work for method tests");
    }),
  );

  suite.addResult(
    createMonoDependentTest("Method-related exports should be available", () => {
      ...
      assert(
        Mono.api.hasExport("mono_method_desc_search_in_image"),
        "mono_method_desc_search_in_image should be available",
      );
  ...
  suite.addResult(
    createMonoDependentTest("Should find and validate System.String methods", () => {
  ...
  suite.addResult(
    createMonoDependentTest("Should invoke static string methods", () => {
      try {
        ...
        if (error instanceof Error && error.message.includes("access violation")) {
          console.log(
            "    (Skipped: IsNullOrEmpty method access violation - method may not be available in this Unity Mono version)",
          );
          return;
        }
        throw error;
  ...
  suite.addResult(
    createMonoDependentTest("Should invoke string concatenation", () => {
      try {
        const corlib = getCorlibImage();
        ...
        if (error instanceof Error && error.message.includes("access violation")) {
          console.log(
            "    (Skipped: Concat method access violation - method may not be available in this Unity Mono version)",
          );
          return;
        }
        throw error;
  ...
  suite.addResult(
    createMonoDependentTest("Should invoke instance methods", () => {
      try {
        const corlib = getCorlibImage();
        ...
        if (error instanceof Error && error.message.includes("access violation")) {
          console.log(
            "    (Skipped: ToUpperInvariant method access violation - method may not be available in this Unity Mono version)",
          );
          return;
        }
        throw error;
  ...
  suite.addResult(
    createMonoDependentTest("Should handle method exceptions", () => {
      try {
        const corlib = getCorlibImage();
        ...
        try {
          ...
          console.log(
            "    (Note: Int32.Parse did not throw exception - may behave differently in this Unity Mono version)",
          );
        } catch (error) {
          if (error instanceof MonoManagedExceptionError) {
            ...
            console.log(
              "    (Skipped: Int32.Parse access violation - method may not be available in this Unity Mono version)",
            );
            return;
          } else {
            console.log(
              `    (Note: Different exception type: ${error instanceof Error ? error.constructor.name : "Unknown"})`,
            );
          }
        }
        ...
        if (error instanceof Error && error.message.includes("access violation")) {
          console.log(
            "    (Skipped: Method access violation - Int32.Parse may not be available in this Unity Mono version)",
          );
          return;
        }
        throw error;
  ...
  suite.addResult(
    createMonoDependentTest("Should find Unity-specific methods", () => {
      const domain = Mono.domain;
  ...
  suite.addResult(
    createMonoDependentTest("Should invoke Unity component methods", () => {
      const domain = Mono.domain;
  ...
  suite.addResult(
    createMonoDependentTest("Should work with method overloads", () => {
      const domain = Mono.domain;
      const stringClass = domain.class("System.String");
      ...
      if (stringClass) {
        ...
        if (concat2Args && concat3Args) {
          assert(
            concat2Args.getParamCount() !== concat3Args.getParamCount(),
            "Overloads should have different parameter counts",
          );
        }
      }
    }),
  ...
  suite.addResult(
    createMonoDependentTest("Should handle generic methods", () => {
      const domain = Mono.domain;
  ...
  suite.addResult(
    createMonoDependentTest("Should validate method signatures", () => {
      const domain = Mono.domain;
      const stringClass = domain.class("System.String");
  ...
  suite.addResult(
    createMonoDependentTest("Field APIs should be available", () => {
  ...
  suite.addResult(
    createMonoDependentTest("Field APIs should be callable", () => {
      assert(
  ...
  suite.addResult(
    createMonoDependentTest("Should access fields through class objects", () => {
  ...
  suite.addResult(
    createMonoDependentTest("Should find specific fields by name", () => {
      const domain = Mono.domain;
      const stringClass = domain.class("System.String");
  ...
  suite.addResult(
    createMonoDependentTest("Should access fields through assembly image classes", () => {
      const domain = Mono.domain;
  ...
  suite.addResult(
    createMonoDependentTest("Should handle non-existent fields gracefully", () => {
      const domain = Mono.domain;
      const stringClass = domain.class("System.String");
  ...
  suite.addResult(
    createMonoDependentTest("Should test field metadata and properties", () => {
      const domain = Mono.domain;
      const stringClass = domain.class("System.String");
  ...
  suite.addResult(
    createMonoDependentTest("Should test field type information", () => {
      const domain = Mono.domain;
      const stringClass = domain.class("System.String");
  ...
  suite.addResult(
    createMonoTest("Property APIs should be callable", () => {
      assert(
        typeof Mono.api.native.mono_class_get_property_from_name === "function",
        "mono_class_get_property_from_name should be a function",
      );
      assert(
        typeof Mono.api.native.mono_property_get_get_method === "function",
        "mono_property_get_get_method should be a function",
      );
      assert(
        typeof Mono.api.native.mono_property_get_set_method === "function",
        "mono_property_get_set_method should be a function",
      );
    }),
  );

  suite.addResult(
    createDomainTest("Should access properties through class objects", domain => {
  ...
  suite.addResult(
    createDomainTest("Should find specific properties by name", domain => {
      const stringClass = domain.class("System.String");
  ...
  suite.addResult(
    createDomainTest("Should access properties through assembly image classes", domain => {
      const assemblies = domain.getAssemblies();
  ...
  suite.addResult(
    createDomainTest("Should handle non-existent properties gracefully", domain => {
      const stringClass = domain.class("System.String");
  ...
  suite.addResult(
    createDomainTest("Should test property metadata and attributes", domain => {
      const stringClass = domain.class("System.String");
        ...
        if (properties.length > 0) {
          ...
          try {
            ...
            if (propertyInfo) {
              ...
              assert(
                Array.isArray(propertyInfo.parameterTypeNames),
                "Property info should include parameter type names",
              );
              assert(
                propertyInfo.parameterCount === propertyInfo.parameterTypeNames.length,
                "Parameter metadata should be internally consistent",
              );
              const parameterSummary =
                propertyInfo.parameterTypeNames.length > 0 ? propertyInfo.parameterTypeNames.join(", ") : "none";
  ...
  suite.addResult(
    createDomainTest("Should expose indexer parameter metadata", domain => {
      const stringClass = domain.class("System.String");
  ...
  suite.addResult(
    createDomainTest("Should test property type information", domain => {
      const stringClass = domain.class("System.String");
  ...
  suite.addResult(
    createDomainTest("Should test different property types", domain => {
  ...
  suite.addResult(
    createDomainTest("Should test field operations consistency", domain => {
  ...
  suite.addResult(
    createDomainTest("Should test property operations consistency", domain => {
      // Test multiple calls return consistent results
      const stringClass1 = domain.class("System.String");
      const stringClass2 = domain.class("System.String");
  ...
  suite.addResult(
    createDomainTestEnhanced("Should handle invalid member inputs gracefully", domain => {
      try {
