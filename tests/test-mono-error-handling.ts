...
class MockMonoMethod {
  ...
  getName() { return this.name; }
  getFullName() { return this.className ? `${this.className}.${this.name}` : this.name; }
}
...
export function testMonoErrorHandling(): TestResult {
  ...
  suite.addResult(createStandaloneTest("MonoError - basic creation and properties", () => {
  ...
  suite.addResult(createStandaloneTest("MonoError - with context and cause", () => {
  ...
  suite.addResult(createStandaloneTest("MonoError - full description", () => {
  ...
  suite.addResult(createStandaloneTest("MonoError - JSON serialization", () => {
  ...
  suite.addResult(createStandaloneTest("MonoValidationError - basic creation", () => {
  ...
  suite.addResult(createStandaloneTest("MonoValidationError - JSON serialization", () => {
  ...
  suite.addResult(createStandaloneTest("validationError helper function", () => {
  ...
  suite.addResult(createStandaloneTest("MonoMemoryError - creation and properties", () => {
  ...
  suite.addResult(createStandaloneTest("MonoInitializationError - creation and properties", () => {
  ...
  suite.addResult(createStandaloneTest("MonoThreadError - creation and properties", () => {
  ...
  suite.addResult(createStandaloneTest("MonoMethodError - creation and properties", () => {
  ...
  suite.addResult(createStandaloneTest("MonoAssemblyError - creation and properties", () => {
  ...
  suite.addResult(createStandaloneTest("MonoTypeError - creation and properties", () => {
    ...
    assert(error.context !== undefined && error.context.includes("System.String"), "Should include expected type in context");
    assert(error.context !== undefined && error.context.includes("System.Int32"), "Should include actual type in context");
  }));
  ...
  suite.addResult(createStandaloneTest("MonoManagedExceptionError - creation and properties", () => {
  ...
  suite.addResult(createStandaloneTest("MonoManagedExceptionError - with stack trace", () => {
  ...
  suite.addResult(createStandaloneTest("monoInvariant - assertion helper", () => {
  ...
  suite.addResult(createStandaloneTest("handleMonoError - error categorization", () => {
  ...
  suite.addResult(createStandaloneTest("handleMonoError - existing MonoError", () => {
  ...
  suite.addResult(createStandaloneTest("handleMonoError - non-Error objects", () => {
  ...
  suite.addResult(createStandaloneTest("withErrorHandling - synchronous wrapper", () => {
    ...
    const failingFn = () => { throw new Error("Test error"); };
  ...
  suite.addResult(createStandaloneTest("withAsyncErrorHandling - asynchronous wrapper", async () => {
    ...
    const failingAsyncFn = async () => { throw new Error("Async test error"); };
  ...
  suite.addResult(createStandaloneTest("MonoResult - success result", () => {
  ...
  suite.addResult(createStandaloneTest("MonoResult - error result", () => {
  ...
  suite.addResult(createStandaloneTest("asResult - function wrapper", () => {
  ...
  suite.addResult(createStandaloneTest("ValidationBuilder - basic usage", () => {
  ...
  suite.addResult(createStandaloneTest("ValidationBuilder - execute method", () => {
  ...
  suite.addResult(createStandaloneTest("ValidationBuilder - custom errors and warnings", () => {
  ...
  suite.addResult(createStandaloneTest("ValidationBuilder - buildOrThrow", () => {
  ...
  suite.addResult(createStandaloneTest("Logger - level filtering", () => {
  ...
  suite.addResult(createStandaloneTest("Logger - tag functionality", () => {
  ...
  suite.addResult(createStandaloneTest("Logger - static convenience methods", () => {
  ...
  suite.addResult(createStandaloneTest("Logger - message formatting", () => {
  ...
  suite.addResult(createErrorHandlingTest("Error recovery - fallback mechanisms", () => {
  ...
  suite.addResult(createErrorHandlingTest("Error recovery - graceful degradation", () => {
    // Test graceful degradation when operations fail
    const primaryOperation = () => { throw new Error("Primary operation failed"); };
  ...
  suite.addResult(createErrorHandlingTest("Error recovery - partial success handling", () => {
  ...
  suite.addResult(createErrorHandlingTest("Unity-specific error handling - MonoBehaviour errors", () => {
  ...
  suite.addResult(createErrorHandlingTest("Unity-specific error handling - Component errors", () => {
  ...
  suite.addResult(createErrorHandlingTest("Unity-specific error handling - Asset loading errors", () => {
  ...
  suite.addResult(createPerformanceTest("Error handling performance - error creation overhead", () => {
  ...
  suite.addResult(createPerformanceTest("Error handling performance - validation builder overhead", () => {
  ...
  suite.addResult(createPerformanceTest("Error handling performance - logging overhead", () => {
  ...
  suite.addResult(createPerformanceTest("Error handling performance - error handling wrapper", () => {
    // Test performance of error handling wrappers
    const successfulFn = () => `result ${Math.random()}`;
    const failingFn = () => { throw new Error(`Error ${Math.random()}`); };
  ...
  suite.addResult(createStandaloneTest("Error reporting - comprehensive error information", () => {
  ...
  suite.addResult(createStandaloneTest("Error reporting - validation result diagnostics", () => {
  ...
  suite.addResult(createStandaloneTest("Error reporting - error aggregation", () => {
  ...
  suite.addResult(createIntegrationTest("Error handling integration - validation with logging", () => {
  ...
  suite.addResult(createIntegrationTest("Error handling integration - error handling with result types", () => {
  ...
  suite.addResult(createIntegrationTest("Error handling integration - comprehensive error workflow", () => {
